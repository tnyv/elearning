...
/* harmony import */ var _screens_profile_profile_component__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./screens/profile/profile.component */ "./src/app/screens/profile/profile.component.ts");
...
const routes = [
    ...
    { path: "profile", component: _screens_profile_profile_component__WEBPACK_IMPORTED_MODULE_5__["ProfileComponent"] },
...
/* harmony import */ var _screens_login_login_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./screens/login/login.component */ "./src/app/screens/login/login.component.ts");
...
/* harmony import */ var _screens_profile_profile_component__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./screens/profile/profile.component */ "./src/app/screens/profile/profile.component.ts");
/* harmony import */ var _screens_register_register_component__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./screens/register/register.component */ "./src/app/screens/register/register.component.ts");
...
HomeComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./home.component.scss */ "./src/app/screens/home/home.component.scss")).default]
    })
], HomeComponent);
...
LoginComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: "app-login",
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./login.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/screens/login/login.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./login.component.scss */ "./src/app/screens/login/login.component.scss")).default]
    })
], LoginComponent);
...
ProfileComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./profile.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/screens/profile/profile.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./profile.component.scss */ "./src/app/screens/profile/profile.component.scss")).default]
    })
], ProfileComponent);
...
let RegisterComponent = class RegisterComponent {
    ...
    onSubmit($event) {
        ...
        if (this.isValid()) {
            this.httpUser
                .register(this.email, this.password1, this.firstName, this.lastName, this.organization)
                .then(() => {
                return this.respond();
            }, (reject) => {
                this.emailValid = false;
...
RegisterComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./register.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/screens/register/register.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./register.component.scss */ "./src/app/screens/register/register.component.scss")).default]
    })
], RegisterComponent);
...
let UserService = class UserService {
    ...
    login(email, password) {
        ...
        return new Promise((resolve, reject) => {
            this.http
                .post(this.baseUrl + "/login", body, { headers })
                .subscribe((res) => {
                console.log(res);
    ...
    register(email, password, firstName, lastName, organization) {
        ...
        return new Promise((resolve, reject) => {
            this.http
                .post(this.baseUrl + "/register", body, { headers })
                .subscribe((res) => {
                resolve();
            }, (error) => {
                reject();
    ...
    getUsers() {
        ...
        return new Promise((resolve, reject) => {
            this.http.get(this.baseUrl + "/getall", { headers: headers }).subscribe((res) => {
                console.log(res);
                // Converting returned JSON into parsable object
                var response = JSON.parse(JSON.stringify(res));
...
module.exports = __webpack_require__(/*! C:\Users\BOSS\Desktop\DEV\LMS\client\src\main.ts */"./src/main.ts");
